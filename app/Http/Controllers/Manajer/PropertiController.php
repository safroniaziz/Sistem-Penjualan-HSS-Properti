...
class PropertiController extends Controller
{
    public function index(){
        ...
        return view('manajer/properti.index', compact('properties'));
    }
    ...
    public function post(Request $request){
        ...
        return redirect()->route('manajer.properti')->with(['success' =>  'Data Properti Berhasil Ditambahkan']);
    }
    ...
    public function delete(Request $request){
        ...
        return redirect()->route('manajer.properti')->with(['success' =>  'Data Properti Berhasil Dihapus']);
    }
