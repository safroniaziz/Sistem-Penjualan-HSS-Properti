...
class PropertiDetailController extends Controller
{
    public function index(){
        ...
        return view('admin/properti_detail.index', compact('details','propertis'));
    }
    ...
    public function post(Request $request){
        ...
        return redirect()->route('admin.properti_detail')->with(['success' =>  'Data Properti Detail Berhasil Ditambahkan']);
    }
    ...
    public function delete(Request $request){
        ...
        return redirect()->route('admin.properti_detail')->with(['success' =>  'Data Properti Detail Berhasil Dihapus']);
    }
