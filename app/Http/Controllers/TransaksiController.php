...
class TransaksiController extends Controller
{
    public function index(){
        ...
        $transaksis = Transaksi::join('properti_details','properti_details.id','transaksis.properti_detail_id')
                                ...
                                ->get();
        return view('admin/transaksi.index',compact('properties','transaksis'));
    }
    ...
    public function post(Request $request){
        ...
        return redirect()->route('admin.transaksi')->with(['success'    =>  'Transaksi untuk "'.$properti->nm_properti.'" dengan nomor kavling "'.$properti->no_kavling.'" berhasil dilakukan !!']);
    }
