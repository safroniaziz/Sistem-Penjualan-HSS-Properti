...
<html>
	<head>
		<meta charset="utf-8">
        <title>HSS Properti | Login</title>
        <link rel="shortcut icon" href="{{ asset('assets/login/images/logo.jpeg') }}">
	...
	<body style="background-image:linear-gradient( rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.4) ), url('{{ asset("assets/login/images/background.jpg") }}')">
		<div id="particles-js">
            <div class="loginBox">
                <img src=" {{ asset('assets/login/images/logo.jpeg') }} " class="user">
                @if ($message = Session::get('error'))
                    ...
                    @else
                    <h6>Halaman Login</h6>
                    <p style="text-align:center; margin-bottom:20px;">Sistem Informasi Penjualan <br> HSS Properti</p>
                @endif
