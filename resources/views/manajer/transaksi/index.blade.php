        ...
        <div class="col-md-12">
            <div class="box box-primary">
                        ...
                        <tbody>
                            ...
                            @foreach ($transaksis as $transaksi)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manajer.transaksi.laporan',[$transaksi->id]) }}" class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o"></i>&nbsp; Cetak</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form method="POST" action="{{ route('manajer.transaksi.post') }}">
    ...
    <script>
        ...
        $(document).ready(function(){
            $(document).on('change','#properti_id',function(){
                ...
                $.ajax({
                type :'get',
                url: "{{ url('manajer/transaksi/cari_detail') }}",
