...
@section('location2')
    <i class="fa fa-user"></i>&nbsp;Informasi Data Detail Properti
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-home"></i>&nbsp;Informasi Data Detail Properti</h3>
                ...
                <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form method="POST" action="{{ route('operator.properti_detail.post') }}">
